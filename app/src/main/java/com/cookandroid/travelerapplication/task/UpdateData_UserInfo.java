...
public class UpdateData_UserInfo extends AsyncTask<String,Void,String> { // 통신을 위한 InsertData 생성
    ...
    protected String doInBackground(String... params) {
        ...
        String image_url = (String)params[3];


        String postParameters ="user_id="+user_id+"&nickname="
                +nickname+"&image_url="+image_url;
