...
public class SelectData_Mission extends AsyncTask<String,Void,String> { // 통신을 위한 InsertData 생성
    ProgressDialog progressDialog;
    private static String TAG = "youn"; //phptest log 찍으려는 용도

    public ArrayList articleArrayList;

    public <T> SelectData_Mission(ArrayList<T> articleArrayList) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            String mission_type = (String) params[1];
            postParameters ="mission_type="+mission_type;
        }catch (Exception e){
        }
