...
class KotlinActivityMeetupPostPlace : AppCompatActivity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listAdapter.setItemClickListener(object : ListAdapter.OnItemClickListener {
            override fun onClick(v: View, position: Int) {
                ...
                Log.d(
                    "listItems",
                    "listItems[position].category_group_code: " + listItems[position].category_group_code
                )
                Log.d(
                    "listItems",
                    "listItems[position].category_group_name: " + listItems[position].category_group_name
                )
        ...
        try {
            if (!intent.getStringExtra("place_address_and_placeName").isNullOrEmpty()) {
                place_address_and_placeName =
                    intent.getStringExtra("place_address_and_placeName").toString()
